...
<body>
	<form name="addUser" action="DeleteDBServlet" method="post">
		<h1>Delete User</h1>
		...
		<label>Gender :</label> <input type="radio" name="gender" value="male"
			readonly checked="checked"> Male <input type="radio"
			name="gender" value="female" readonly> Female <input
			type="radio" name="gender" value="other" readonly> Other <br>
		<br>
		<%
		...
		<label>Gender :</label> <input type="radio" name="gender" value="male"
			...
			value="female" readonly checked="checked"> Female <input
			type="radio" name="gender" value="other" readonly> Other <br>
		<br>
		<%
			} else {
		...
		<label>Gender :</label> <input type="radio" name="gender" value="male"
			...
			name="gender" value="other" readonly checked="checked"> Other
		<br> <br>
		<%
			}
		%>
